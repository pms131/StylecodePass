...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="lib/zabuto-calendar/zabuto_calendar.css">
...
<body>
    ...
    *********************************************************************************************************************************************************** -->
        ...
        <aside>
            <div id="sidebar"  class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        <a href="http://icecoder.azurewebsites.net/lib/login.php" >
    ...
    <script class="include" type="text/javascript" src="node_modules/dcjqaccordion/js/jquery.dcjqaccordion.2.7.js"></script>
    ...
    <script src="lib/sparklines/jquery.sparkline.min.js"></script>

    <!--common script for all pages-->
    <script src="lib/common-scripts/common-scripts.js"></script>
    
    <script type="text/javascript" src="lib/gritter/js/jquery.gritter.js"></script>
    <script type="text/javascript" src="lib/gritter-conf/gritter-conf.js"></script>

    <!--script for this page-->
    <script src="lib/sparklines-chart/sparkline-chart.js"></script>    
    <script src="lib/zabuto-calendar/zabuto_calendar.min.js"></script>
